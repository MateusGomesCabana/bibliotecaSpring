...
import br.bliblioteca.livros.servico.SecurityService;
import br.bliblioteca.livros.servico.UserService;
import br.bliblioteca.livros.validator.LoginValidator;
import br.bliblioteca.livros.validator.UserValidator;
...
//        return new ModelAndView("/user/listadmin", "users", users);
    ...
    public ModelAndView registration() {
        ...
        return new ModelAndView("user/formRegistration", "userForm", new User());
    }
    ...
    public ModelAndView registrationform(@ModelAttribute("userForm") User userForm, BindingResult bindingResult, Model model) {
        ...
        if (bindingResult.hasErrors()) {
            return new ModelAndView("user/formRegistration");
        }
